...
import * as base64url from "oidc-provider/lib/helpers/base64url.js";
import * as attention from "oidc-provider/lib/helpers/attention.js";
import { errors, interactionPolicy as defaultPolicy } from "oidc-provider";
...
function makeDefaults() {
  const defaults = {
     ...
     *
     */
    jwks: JSON.parse(JSON.stringify(keystore)),
